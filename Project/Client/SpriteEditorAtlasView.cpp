...
SpriteEditorAtlasView::SpriteEditorAtlasView()
	: m_WidthSize(200)
	, m_WheelScale(1.f)
{
}
...
void SpriteEditorAtlasView::Initialize()
{
}

void SpriteEditorAtlasView::Update()
{
...
void SpriteEditorAtlasView::SetAtlasTex(Ptr<HHTexture> _Tex)
{
	if (m_AtlasTex == _Tex)
		return;
...
void SpriteEditorAtlasView::WheelCheck()
{
...
void SpriteEditorAtlasView::SelectCheck()
{
	// Image 위젯 좌상단 좌표
...
void SpriteEditorAtlasView::DrawSelectRect()
{
...
void SpriteEditorAtlasView::CalculateSpriteSize(Vec2 _PixelPos)
{
...
bool SpriteEditorAtlasView::IsValidPixel(Vec2 _PixelPos)
{
