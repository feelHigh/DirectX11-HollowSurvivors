...
HHConstantBuffer::HHConstantBuffer()
    : m_Desc{}
{
}
...
int HHConstantBuffer::Create(CONSTANT_BUFFER_TYPE _type, UINT _BufferSize)
{
...
void HHConstantBuffer::SetData(void* _pData)
{
...
void HHConstantBuffer::Binding_CS()
{
    CONTEXT->CSSetConstantBuffers((UINT)m_CBType, 1, m_CB.GetAddressOf());
}
