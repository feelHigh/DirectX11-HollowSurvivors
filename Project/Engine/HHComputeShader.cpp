...
HHComputeShader::HHComputeShader(UINT _ThreadPerGroupX, UINT _ThreadPerGroupY, UINT _ThreadPerGroupZ
								, const wstring& _ShaderRelativePath, const string& _FuncName)
	: HHShader(ASSET_TYPE::COMPUTE_SHADER)
...
HHComputeShader::~HHComputeShader()
{
}

int HHComputeShader::Execute()
{
	if (FAILED(Binding()))
		return E_FAIL;
...
int HHComputeShader::CreateComputeShader(const wstring& _RelativePath, const string& _FuncName)
{
