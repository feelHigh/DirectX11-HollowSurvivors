...
HHStructuredBuffer::HHStructuredBuffer()
	: m_Desc{}
	, m_ElementCount(0)
	, m_ElementSize(0)
...
int HHStructuredBuffer::Create(UINT _ElementSize, UINT _ElementCount, 
...
void HHStructuredBuffer::SetData(void* _pData, UINT _DataSize)
{
...
void HHStructuredBuffer::GetData(void* _pData, UINT _DataSize)
{
...
void HHStructuredBuffer::Binding(UINT _RegisterNum)
{
...
void HHStructuredBuffer::Binding_CS_SRV(UINT _RegisterNum)
{
	m_RecentRegisterNum = _RegisterNum;
	CONTEXT->CSSetShaderResources(_RegisterNum, 1, m_SRV.GetAddressOf());
}

void HHStructuredBuffer::Binding_CS_UAV(UINT _RegisterNum)
{
	m_RecentRegisterNum = _RegisterNum;
	UINT i = -1;
...
void HHStructuredBuffer::Clear(UINT _RegisterNum)
{
...
void HHStructuredBuffer::Clear_CS_SRV()
{
	ID3D11ShaderResourceView* pSRV = nullptr;
	CONTEXT->CSSetShaderResources(m_RecentRegisterNum, 1, &pSRV);
}

void HHStructuredBuffer::Clear_CS_UAV()
{
